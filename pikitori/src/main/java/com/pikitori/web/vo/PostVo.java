...
public class PostVo {
	...
	public String toString() {
		return "PostVo [post_no=" + post_no + ", post_content=" + post_content + ", post_movie=" + post_movie
				+ ", post_regdate=" + post_regdate + ", post_ispublic=" + post_ispublic + ", post_comment_count="
				+ post_comment_count + ", heartflag=" + heartflag + ", post_heart_count=" + post_heart_count
				+ ", user_no=" + user_no + ", user_name=" + user_name + ", user_profile_url=" + user_profile_url
				+ ", commentList=" + commentList + ", pictureList=" + pictureList + ", tagList=" + tagList + "]";
	}
